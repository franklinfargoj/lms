...
$config['csrf_exclude_uris'] = array('api/v1/api/authentication','api/v1/api/add_lead',
    ...
    'api/v1/api/leads_assigned_list','api/v1/api/product_details','api/v1/api/unassigned_leads_list','api/v1/api/unassigned_leads','api/v1/api/assigned_leads_list','api/v1/api/lead_details','api/v1/api/assign_to');
