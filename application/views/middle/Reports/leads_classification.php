...
<!--                                </td>-->
                            ...
                            <td style="text-align:center">
                                <?php 
                                    echo isset($value['ticket']) ? convertCurrency($value['ticket']) : '';
                                ?>
                            </td>
                            <td style="text-align:center">
                                <?php
                                echo isset($value['amount']) ? convertCurrency($value['amount']) : '';
                                ?>
                            </td>
                            <?php if(in_array($viewName,array('ZM','BM'))){
                                $param = '';
                                ...
                                <?php 
                                    if(in_array($viewName,array('ZM','BM'))){
                                        if($view == 'employee'){
                                                ...
                                                ?>
                                                <a class=""
                                                   href="<?php echo site_url('reports/index/leads_classification/employee' . $param) ?>">
                                                    Employee View
                                                </a>
                                                <?php
