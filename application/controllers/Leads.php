...
//                    unlink($file['full_path']);
    ...
    public function unassigned_leads(){
        ...
        $where = array(Tbl_Leads . '.branch_id' => $login_user['branch_id'],Tbl_LeadAssign.'.lead_id'=>NULL,'YEAR('.Tbl_Leads.'.created_on)' => date('Y'),Tbl_Leads .'.created_on >= DATE_ADD( CURDATE( ) , INTERVAL -45 DAY )',Tbl_LeadAssign.'.is_updated'=>1);
