...
class Faq_model extends CI_Model{
	...
	public function add_record($data){
		return $this->insert(Tbl_Faq,$data);
	}
	...
	public function edit_record($id,$data){
		$where['id'] = $id;
		return $this->update($where,Tbl_Faq,$data);
	}
	...
	public function delete_record($id){
		$where[] = $id;
		$data['is_deleted'] = 1;
		return $this->soft_delete($where,Tbl_Faq,$data);
	}
	...
	public function view_record($id = null,$order_by = array()){
		...
		$join = array();
		return $this->view($select,$where,Tbl_Faq,$join,$order_by);
	}
