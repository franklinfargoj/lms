        ...
        <?php if(!empty($lead_data)){?>
           ...
           <?php if (isset($lead_data[0])){?>
            ...
            <li class="is-hidden timeline-item inverted"> <!-- Normal block, positionned to the left -->
                ...
                <p>
                <?php
                echo isset($lead_data[0]['generated']) && !empty($lead_data[0]['generated']) ? "Generated By : ".ucwords(strtolower($lead_data[0]['generated'])).'<br><br>' : 'Generated By NA<br><br>';
                ?>
                </p>
                <hr>
                <span>
                    <?php echo isset($lead_data[0]['generated_on']) && !empty($lead_data[0]['generated_on']) ? "Date : ".date('d-M-Y',strtotime($lead_data[0]['generated_on'])) : "Date : NA"; ?>
                    ...
                    <ul class="timeline-items">
                        <li class="is-hidden timeline-item <?php echo $right;?>"> <!-- Normal block, positionned to the left -->
                            ...
                            <p>
                                ...
                                echo isset($lead_value['reroute_to_branch_id']) && !empty($lead_value['reroute_to_branch_id']) ? "Reroute From Branch Id : ".$lead_value['reroute_to_branch_id'].'<br><br>' : 'Reroute From Branch Id : NA<br><br>';
                                ?>
                ...
                elseif($key!=0 && !isset($lead_value['reroute_from_branch_id'])){
                    ...
                    <ul class="timeline-items">
                        <li class="is-hidden timeline-item <?php echo $right;?>"> <!-- Normal block, positionned to the left -->
                            ...
                            <hr>
                            <span><?php
                                echo isset($lead_value['date']) && !empty($lead_value['date']) ? "Date : ".date('d-M-Y',strtotime($lead_value['date'])) : "Date : NA";
                                ?></span>
                        </li>
                    </ul>
                <?php }
