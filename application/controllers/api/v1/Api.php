    ...
    */
    ...
    public function assigned_leads_list_post()
    {
        ...
        if (!empty($params) && isset($params['type']) && !empty($params['type'] && isset($params['id']) && !empty($params['id']))) {
            ...
            $select = array('l.id', 'l.customer_name','l.contact_no', 'l.lead_identification', 'l.created_on', 'l.lead_source', 'p.title', 'la.status'/*,'p1.title as interested_product_title'*/, 'r.remind_on','DATEDIFF(CURDATE( ),la.created_on) as elapsed_day');
