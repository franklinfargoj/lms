			...
			<div class="form-group">
				<div class="radio-list">
					<label class="radio-inline">
						<input type="radio" id= "is_own_branch" name="is_own_branch" value="1" <?php echo  set_radio('is_own_branch', '1', TRUE); ?> />
						Own Branch
					</label>
					<label class="radio-inline">
						<input type="radio" id="is_other_branch" name="is_own_branch" value="0" <?php echo  set_radio('is_own_branch', '0'); ?> />
						Other Branch
					</label>
				</div>
