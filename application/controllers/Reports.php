                ...
                if($key > 0){
                    ...
                    if(isset($value[0]['reroute_from_branch_id'])) {
                        if ($value[$key]['status'] == 'NC' && $value[$key]['assignee_branch'] == $value[0]['reroute_from_branch_id']) {
                            ...
                            $objSheet->getCell($excel_alpha[15] . $i)->setValue(ucwords($value[0]['reroute_from_branch_id']));
                        ...
                        $objSheet->getCell($excel_alpha[13] . $i)->setValue(ucwords($value[$key]['employee_name']));
                        $objSheet->getCell($excel_alpha[14] . $i)->setValue(ucwords($value[$key]['employee_id']));
                        $objSheet->getCell($excel_alpha[15] . $i)->setValue(ucwords($value[0]['branch_id']));
                    ...
                    if($value[$key]['status'] == 'FU'){
                        ...
                        $objSheet->getCell($excel_alpha[23] . $i)->setValue(ucwords($value[$key]['modified_by_name']));
                        $objSheet->getCell($excel_alpha[24] . $i)->setValue(ucwords($value[$key]['modified_by']));
                        $objSheet->getCell($excel_alpha[25] . $i)->setValue(ucwords($lead_type[$value[0]['lead_identification']]));
                    }
                    ...
                    if($value[$key]['status'] == 'NI'){
                        ...
                        $objSheet->getCell($excel_alpha[35] . $i)->setValue(ucwords($value[$key]['reason_for_drop']));
                    }
                    ...
                    if($value[$key]['status'] == 'Converted'){
                        ...
                        $objSheet->getCell($excel_alpha[39] . $i)->setValue(ucwords($value[0]['opened_account_no']));
                        $objSheet->getCell($excel_alpha[40] . $i)->setValue(ucwords($value[0]['amount']));
                    }
