...
//        }
        ...
        foreach($arrData['generated_leads'] as $row){
            ...
            $final_result = array();
            $action = 'list';
            $select = array('l.id','l.customer_name','l.lead_source','l.contact_no','l.created_by_branch_id','l.created_on AS generated_on','l.reroute_from_branch_id','l.modified_on','l.branch_id','l.created_by_name as generated','rfc.amount','l.opened_account_no','l.created_by_zone_id');
            $table = Tbl_Leads.' as l';
            $join = array();
